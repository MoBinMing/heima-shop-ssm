...
<body>
	<div class="container-fluid">
		...
		<div class="container-fluid">
			...
			<div class="col-md-10" id="findNew">
				<div class="col-md-6"
					style="text-align: center; height: 200px; padding: 0px;">
					<a href="product_info.htm"> <img
						src="products/hao/middle01.jpg" width="516px" height="200px"
	...
	<script type="text/javascript">
		$(function() {
			$.post('/heima-shop-ssm/findNew', function(data,status) {
				var dom = "";
				var arr = JSON.parse(data);
				console.log(JSON.stringify(arr));
				for (var i = 0; i < arr.length; i++) {
					var temp = "<div class=\"col-md-2\"\r\n" + 
					"					style=\"text-align: center; height: 200px; padding: 10px 0px;\">\r\n" + 
					"					<a href=\"product_info.htm\"> <img src=\""+arr[i].pimage+"\"\r\n" + 
					"						width=\"130\" height=\"130\" style=\"display: inline-block;\">\r\n" + 
					"					</a>\r\n" + 
					"					<p>\r\n" + 
					"						<a href=\"product_info.html\" style='color: #666'>"+arr[i].pname+"</a>\r\n" + 
					"					</p>\r\n" + 
					"					<p>\r\n" + 
					"						<font color=\"#E4393C\" style=\"font-size: 16px\">&yen;"+arr[i].shop_price+"</font>\r\n" + 
					"					</p>\r\n" + 
					"				</div>";
					dom+=temp;
				};
