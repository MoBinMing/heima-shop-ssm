	...
	<div class="container-fluid">
		...
		<div class="container-fluid">
			...
			<div class="col-md-10">
				...
				<c:forEach var="hot" items="${findHot}">
					<div class="col-md-2"
						style="text-align: center; height: 200px; padding: 10px 0px;">
						<a href="product_info.htm"> <img
							src="${hot.pimage}" width="130" height="130"
							style="display: inline-block;">
						</a>
						<p>
						...
						<p>
							<font color="#E4393C" style="font-size: 16px">&yen;${hot.shop_price}</font>
						</p>
					</div>
				</c:forEach>
			</div>
