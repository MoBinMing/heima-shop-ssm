	...
	<div class="container">
		<div class="row">
			<div
				...
				<a href="./index">首页&nbsp;&nbsp;&gt;</a> <a href="<c:url value='/product/findByCid?cid=${product.category.cid}'/>">${product.category.cname}&nbsp;&nbsp;&gt;</a>
				<a>${product.pname}</a>
			</div>
			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div style="margin: 10px 0 10px 0;">
						商 场 价: <strong style="color: #ef0101;">￥：${product.shop_price}元/份</strong> 参 考 价：
