		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form 
					...
					action="<c:url value='/user/regist'/>"
					method="POST">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="email" class="form-control" id="email"
								placeholder="Email" name="email" value="xiaoqunhu@heima.com">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" id="name"
								placeholder="请输入姓名" name="name" value="肖群虎">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="date" class="form-control" 
								id="birthday" name="birthday" value="2018-04-07">
						</div>
					</div>
