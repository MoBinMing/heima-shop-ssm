...
<div class="row" style="width: 1210px; margin: 0 auto;">
	<c:forEach var="product" items="${products.list}">
		<div class="col-md-2">
			<a href="product_info.jsp"> <img src="${product.pimage}"
...
<div style="width: 380px; margin: 0 auto; margin-top: 50px;">
	<ul class="pagination" style="text-align: center; margin-top: 10px;">
		...
		<c:forEach begin="1" end="${products.pages}" step="1" varStatus="varStatus">
			<li class="${products.pageNum==varStatus.current? 'active':''}">
				<a href="<c:url value='/product/findByCid?cid=${param.cid}&pageNum=${varStatus.current}'/>">${varStatus.current}</a>
			</li>
			<!-- <li><a href="#">2</a></li> -->
		</c:forEach>
